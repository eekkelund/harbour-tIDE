...
%{_localstatedir}/lib/harbour-sailorcreator-keyboard/config/
%{_localstatedir}/lib/harbour-sailorcreator-keyboard/database/
%defattr(-,root,root,-)
%{_bindir}/%{name}/
%{_datadir}/%{name}/
...
%{_datadir}/maliit/plugins/com/jolla/sailorcreator/
# >> files
# << files
